#
#  Be sure to run `pod spec lint elib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/andreyweather/elib.git", :tag => "#{spec.version}" }

  spec.source_files  = "elib/*.{swift}"
